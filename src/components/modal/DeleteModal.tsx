...
import { useDeleteJobsMutation } from "../../redux/features/category/categoryApi";

type TProps = {
  jobId: string;
};

const DeleteModal = ({ jobId }: TProps) => {
  const [modalOpen, setModalOpen] = useState(false);

  const [deleteJob, { isLoading, isSuccess }] = useDeleteJobsMutation();
